...
class VelasDAO
{
    ...
    public function selectAll(string $param = ""): array
    {
        try {
            ...
            error_log("Error en selectAll de VelaDAO: " . $e->getMessage());
            return [];
        }
    }
    ...
    public function selectOne(int $id_vela): ?array
    {
        try {
            ...
            error_log("Error en selectOne de VelaDAO: " . $e->getMessage());
            return null;
        }
    }
    ...
    public function insert(Vela $vela): bool
    {
        try {
            ...
            error_log("Error en insert de VelaDAO: " . $e->getMessage());
            return false;
        }
    }
    ...
    public function update(Vela $vela): bool
    {
        try {
            ...
            error_log("Error en update de VelaDAO: " . $e->getMessage());
            return false;
        }
    }
